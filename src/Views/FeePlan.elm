...
showOver3000CreditMessage l10n ({ max_purchase_amount, installments_count, customer_fee_variable, maximum_interest_rate, is_under_maximum_interest_regulated_rate } as fee_plan) =
    if max_purchase_amount > 3000 then
        div [ class "col-xs-12", style "background-color" "#f6f6f6", style "margin" "10px 0" ]
            [ showOverRate l10n fee_plan
            , p [ style "margin" "10px" ]
